        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('password.email') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block" style="background-color: #eb47ebcc; border-color: #eb47ebcc; color: white;">Request new password</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                ...
                @if (Route::has('register'))
                    <p class="mb-0">
                        <a href="{{ route('register') }}" class="text-center" style="color: #eb47ebcc;">Register a new account</a>
                    </p>
                @endif
            </div>
            <!-- /.login-card-body -->
