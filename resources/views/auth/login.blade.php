                    ...
                    <div class="card-body login-card-body" style="border-radius: 10px;">
                        ...
                        <script src="{{ asset('js/togglepassword.js') }}"></script>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center icheck-primary">
                                        ...
                                        <p class="mb-0 ml-auto">
                                            <a href="{{ route('password.request') }}" style="color: #eb47ebcc;">{{ __('Forgot Your Password?') }}</a>
                                        </p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary btn-block" style="border-radius: 30px; background-color: #eb47ebcc; border: none;">{{ __('Login') }}</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <p class="mb-4 text-center">
                            <a href="{{ route('register') }}" style="color: #eb47ebcc;">{{ __('Do Not have an account? Register Here') }}</a>
                        </p>
                        @endif
                    </div>
                </div>
