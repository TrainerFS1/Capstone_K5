    ...
    <body class="hold-transition register-page" style="background-color: #eb47ebcc;">
        <div class="login-container" style="display: flex; height: 100vh;">
            <div class="login-image"
                ...
                <img src="{{ asset('assetsLanding/img/undraw_regis.svg') }}" alt="Image" class="img-fluid"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary btn-block"
                                    style="border-radius: 30px; background-color: #eb47ebcc; border: none;">{{ __('Register') }}</button>
                            </div>
                        </div>
                        </form>
                        </br>
